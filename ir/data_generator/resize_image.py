...
RAW_DATA_DIRECTORY = '/Users/ongcj/Dev/mdp/ir/data/processed/environment'
width = 240
...
for image in all_images:
    ...
    resized_img.save(join(RAW_DATA_DIRECTORY, full_path_to_img.replace(".JPG", "_ROTATED_RESIZED.JPG")), "JPEG", optimize=True)
